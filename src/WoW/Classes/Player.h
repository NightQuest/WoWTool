...
public:
	...
	float GetWalkSpeed();
	float GetRunSpeed();
	float GetRunBackwardsSpeed();
	float GetSwimSpeed();
	float GetSwimBackwardsSpeed();
	float GetFlySpeed();
	float GetFlyBackwardsSpeed();
	float GetYawRotateSpeed();
	float GetPitchRotateSpeed();
	bool SetCurrentMovementSpeed(float speed);
	bool SetWalkSpeed(float speed);
	bool SetRunSpeed(float speed);
	bool SetRunBackwardsSpeed(float speed);
	bool SetSwimSpeed(float speed);
	bool SetSwimBackwardsSpeed(float speed);
	bool SetFlySpeed(float speed);
	bool SetFlyBackwardsSpeed(float speed);
	bool SetYawRotateSpeed(float speed);
	bool SetPitchRotateSpeed(float speed);
};
